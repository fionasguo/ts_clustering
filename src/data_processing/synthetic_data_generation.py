...
if __name__ == '__main__':
    ...
    with open('/nas/home/siyiguo/user_similarity/data/synthetic_data_X.pkl','wb') as f:
        pickle.dump(syn_data_X,f)
    with open('/nas/home/siyiguo/user_similarity/data/synthetic_data_y.pkl','wb') as f:
